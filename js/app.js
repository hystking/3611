...
var async = require("async"),
    ...
    SVGLine = require("./SVGLine");

var App = function(w, d){
  this.w = w;
  this.d = d;
  this.svgLineAh1 = new SVGLine(ah1);
};
App.prototype = {
  "start": function(callback){
    async.series([
  ...
  "main": function(callback){
    var svgLineAh1 = this.svgLineAh1;
...
},{"./Animation":3,"./Easing":5,"./SVGLine":6,"async":1}],5:[function(require,module,exports){
module.exports = {
  "easeIn": function(t){
    return t * t;
  },
...
var SVGLine = function(dom, len){
  this.dom = dom;
  this.len = len = len | dom.getTotalLength();
  dom.setAttribute("stroke-dasharray", len+"px, "+len+"px");
  this.set(1);
};
